    ...
    if (langTag.includes("'")) {
      if (langTag.includes("msgkey")) {
        ...
        langMap.set(
          "msgkey",
          langTag.substring(
            msgKeyFirstIndex + msgKeyMidIndex,
            msgKeyFirstIndex + msgKeyMidIndex + msgKeyLastIndex
          )
        );
      }
      if (langTag.includes("nullvalue")) {
        ...
        langMap.set(
          "nullvalue",
          langTag.substring(
            nullValueFirstIndex + nullValueMidIndex,
            nullValueFirstIndex + nullValueMidIndex + nullValueLastIndex
          )
        );
      }
    } else {
